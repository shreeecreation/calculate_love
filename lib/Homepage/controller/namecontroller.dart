...
class ResultController {
  static String controlresult(results) {
    ...
    if (result > 10 && result <= 20) {
      a = "Your have some kind of connection but you will have break up soon my boe.";
    }
    if (result > 20 && result <= 30) {
      a = "Chill you are also having a break up kid. Study now you will never regret.";
    }
    if (result > 30 && result <= 40) {
      a = "Don't laugh youre also having break up future. You would have a great connection with each other but you will broke up due to your ego.";
    }
    if (result > 40 && result <= 50) {
      a = "50 huh ?  You are also having a break up soon, Third person will come into your life and one person heart will broke into pieces.";
    }
    if (result > 50 && result <= 60) {
      a = "Congratulations youre the first person to marriage with your partner in this list, You will have marriage staty chill but with whom we don't know. ";
    }
    ...
    if (result > 70 && result <= 80) {
      a = "You both may have healthy relationship with each other. Both will be happy with each other and will lilve a happy life.";
    }
